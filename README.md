...
정확한 동물장기 규칙 엔진, 성능별 예제 AI 5종, 전수 상태 그래프/후퇴 분석기, 브라우저 대국 UI를 한 프로젝트에 담았습니다.
...
├─ index.html / styles.css / app.js   # 대국·AI 선택·탐색 계측 UI
├─ engine.js                          # 순수 규칙 엔진
...
- 브라우저에서 사람 첫 수 → v5 응수 → 기보/탐색 노드 갱신 확인
- 브라우저 경고/오류 로그 없음
